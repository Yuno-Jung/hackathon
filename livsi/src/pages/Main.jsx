...
const Main = () => {
  ...
  const handleSelectAllDistricts = () => {
    ...
    const allDistrictsInCity = locations[selectedCity]
    const areAllSelected =
      allDistrictsInCity.length === selectedDistricts.length

    if (areAllSelected) {
      setSelectedDistricts([]) // 전체 해제
    } else {
      setSelectedDistricts(allDistrictsInCity) // 전체 선택
    }
  }
  ...
  return (
    <div className="main-container">
      <Header toggleMenuBsr={toggleMenuBar} />
      <div className="location-container">
        <div className="location-wrapper">
          ...
          <div
            className={`location-expansion-panel ${
          ...
          >
            ...
            <div
              className={`accordion-panel ${isCityPanelOpen ? "expanded" : ""}`}
            >
            ...
            <div
              ...
              onClick={() =>
                selectedCity && setIsDistrictPanelOpen(!isDistrictPanelOpen)
              }
            >
              <span>구/군 선택</span>
              <span
                className={`accordion-arrow ${
                  isDistrictPanelOpen ? "expanded" : ""
                }`}
              >
                ▼
              </span>
                  ...
                  <div className="location-grid">
                    {locations[selectedCity].map((district) => (
                      <button
                        key={district}
                        className={`location-button ${
                          selectedDistricts.includes(district) ? "selected" : ""
                        }`}
            ...
            <div className="button-group">
              <button className="all-undo-button" onClick={allUnDo}>
                선택취소
              </button>
